package com.holley.elecsafe.common;
...
public class ValidateUtil {
    ...
    public static LoginCountBean initLogin(String account, KeySessionTypeEnum type) {
        ...
        LoginCountBean lcbean = ESCacheUtil.getLoginCount(account, type);
        if (lcbean != null) {
        ...
        ESCacheUtil.setLoginCount(account, type, lcbean);
        return lcbean;
    }
    ...
    public static void clearLoginBean(String account, KeySessionTypeEnum type) {
        ESCacheUtil.removeLoginCount(account, type);
    }
